...
import top.qiguaiaaaa.fluidgeography.api.configs.GeneralConfig;
...
import static top.qiguaiaaaa.fluidgeography.api.util.FluidUtil.*;
...
public final class FluidOperationUtil {
    ...
    public static boolean triggerDestroyBlockEffectByFluid(World worldIn, BlockPos pos, IBlockState state, Fluid destroyer){
        ...
        boolean canDropItem = (destroyer == null || destroyer.getTemperature(worldIn, pos) < GeneralConfig.leastTemperatureForFluidToCompletelyDestroyBlock.getValue().value);
