...
public final class GeoBlockProperty {
    private static final BlockPropertyQuery<Byte> BLOCK_REFLECTIVITY = new BlockPropertyQuery<>((byte)12);
    private static final BlockPropertyQuery<Integer> BLOCK_HEAT_CAPACITY = new BlockPropertyQuery<>(2000);
    ...
    public static float getBlockReflectivity(IBlockState state){
        return BLOCK_REFLECTIVITY.queryPropertyValue(state)/100.0f;
    }
    ...
    public static int getBlockHeatCapacity(IBlockState state){
        return BLOCK_HEAT_CAPACITY.queryPropertyValue(state);
    }
