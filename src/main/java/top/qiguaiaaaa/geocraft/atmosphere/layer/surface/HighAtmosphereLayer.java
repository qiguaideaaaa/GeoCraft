...
import static top.qiguaiaaaa.geocraft.atmosphere.layer.surface.MiddleAtmosphereLayer.第二温度过渡区间长度;
...
public class HighAtmosphereLayer extends SurfaceAtmosphereLayer {
    ...
    protected double[] 对外长波辐射() {
        ...
        double 总量 = 长波发射率 * AtmosphereUtil.FinalFactors.斯特藩_玻尔兹曼常数 *
                ...
                AtmosphereUtil.FinalFactors.大气单元底面积* GeoAtmosphereSetting.getSimulationGap() /2000 * Altitude.to物理高度(getDepth());
    ...
    @Override
    public void tick(Chunk chunk, Map<EnumFacing, Triple<Atmosphere, Chunk, EnumFacing>> neighbors,int x,int z) {
