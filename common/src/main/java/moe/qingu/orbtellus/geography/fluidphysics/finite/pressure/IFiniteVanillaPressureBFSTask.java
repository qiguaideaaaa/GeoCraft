...
import static moe.qingu.orbtellus.geography.fluidphysics.ThreadLocalHelper.MUTABLE_BLOCK_POS_FOR_REALITY_BFS;

/**
 * @author QiguaiAAAA
 */
public interface IFiniteVanillaPressureBFSTask extends IFinitePressureBFSTask, IFiniteVanillaPressureSearchTask {
    @Override
