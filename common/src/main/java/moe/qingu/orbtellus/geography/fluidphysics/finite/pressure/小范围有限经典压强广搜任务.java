...
/**
 * @see IFiniteClassicPressureBFSTask
 * @author QiguaiAAAA
 */
public class 小范围有限经典压强广搜任务 extends 小范围有限压强广搜任务 implements IFiniteClassicPressureBFSTask {
    protected final byte beginQuanta;
    protected final byte quantaPerBlock;
    protected final byte densityDir;

    小范围有限经典压强广搜任务(@Nonnull Fluid fluid, @Nonnull IBlockState beginState, @Nonnull BlockPos beginPos, int searchRange, int quantaPerBlock) {
    ...
    static class Debug extends 小范围有限经典压强广搜任务 implements IFiniteDebugPressureBFSTask.IFiniteClassicDebugPressureBFSTask {
        ...
        Debug(@Nonnull Fluid fluid, @Nonnull IBlockState beginState, @Nonnull BlockPos beginPos, int searchRange, int quantaPerBlock) {
            ...
            OrbTellusCraft.getLogger().info("{} is created",this);
        }
        ...
        public BlockPos pull() {
            OrbTellusCraft.getLogger().info("{} pulled {}",this,peek());
            return super.pull();
        }
