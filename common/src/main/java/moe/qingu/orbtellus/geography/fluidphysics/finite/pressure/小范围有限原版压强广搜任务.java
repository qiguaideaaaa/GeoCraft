...
/**
 * @see IFiniteVanillaPressureBFSTask
 * @author QiguaiAAAA
 */
public class 小范围有限原版压强广搜任务 extends 小范围有限压强广搜任务 implements IFiniteVanillaPressureBFSTask {
    protected final byte beginQuanta;

    小范围有限原版压强广搜任务(@Nonnull Fluid fluid, @Nonnull IBlockState beginState, @Nonnull BlockPos beginPos, int searchRange) {
    ...
    static class Debug extends 小范围有限原版压强广搜任务 implements IFiniteDebugPressureBFSTask.IFiniteVanillaDebugPressureBFSTask {
