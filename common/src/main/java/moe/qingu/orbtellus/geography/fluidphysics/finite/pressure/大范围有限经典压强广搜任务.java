 ...
 * @author QiguaiAAAA
 */
public class 大范围有限经典压强广搜任务 extends 大范围有限压强广搜任务 implements IFiniteClassicPressureBFSTask {
    protected final byte beginQuanta;
    protected final byte quantaPerBlock;
    protected final byte densityDir;

    大范围有限经典压强广搜任务(@Nonnull Fluid fluid, @Nonnull IBlockState beginState, @Nonnull BlockPos beginPos, int searchRange, int quantaPerBlock) {
    ...
    static class Debug extends 大范围有限经典压强广搜任务 implements IFiniteDebugPressureBFSTask.IFiniteClassicDebugPressureBFSTask {
