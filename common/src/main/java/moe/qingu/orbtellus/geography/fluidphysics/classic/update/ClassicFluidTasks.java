...
package moe.qingu.orbtellus.geography.fluidphysics.classic.update;
...
import moe.qingu.orbtellus.geography.fluidphysics.vanilla.update.VanillaFluidClassicFluidTask;
import moe.qingu.orbtellus.mixin.classic.BlockDynamicLiquidMixin;
...
public final class ClassicFluidTasks {
    ...
    /**
     * 经典模式下 {@link FluidTasks#WATER_TASK}、{@link FluidTasks#LAVA_TASK} 由 {@link BlockDynamicLiquidMixin}
     * 使用 {@link DeferredActions} 在 init 阶段注册
     */
