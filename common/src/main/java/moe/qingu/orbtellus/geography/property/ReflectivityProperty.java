...
import moe.qingu.orbtellus.api.property.INumberProperty;
import moe.qingu.orbtellus.geography.state.ReflectivityState;

import javax.annotation.Nonnull;

public class ReflectivityProperty extends GeographyProperty implements INumberProperty<Double> {
    public static final ReflectivityProperty REFLECTIVITY = new ReflectivityProperty();
    private ReflectivityProperty(){
        setRegistryName(OrbTellusCraft.MODID,"reflectivity");
    }
