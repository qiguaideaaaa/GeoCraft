...
import moe.qingu.orbtellus.geography.state.HeatCapacityState;
import moe.qingu.orbtellus.geography.state.ReflectivityState;

import javax.annotation.Nonnull;
import javax.annotation.Nullable;
import java.util.Map;

import static moe.qingu.orbtellus.util.ChunkUtil.getSameLiquidDepth;
...
public class SurfaceUnderlying extends UnderlyingLayer {
    ...
    protected TemperatureState deepTemperature = OTCProperties.DEEP_TEMPERATURE.getStateInstance();
    ...
    public SurfaceUnderlying(Atmosphere atmosphere) {
        ...
        states.put(OTCProperties.DEEP_TEMPERATURE,deepTemperature);
