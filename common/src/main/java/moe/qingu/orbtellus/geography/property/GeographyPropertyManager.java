...
import moe.qingu.orbtellus.api.property.IGeographyPropertyManager;
...
import moe.qingu.orbtellus.util.registry.ServerOnlyRegistryBuilder;
...
public final class GeographyPropertyManager implements IGeographyPropertyManager {
    ...
    private static final ResourceLocation NAME = new ResourceLocation(OrbTellusCraft.MODID,"geography_property");
