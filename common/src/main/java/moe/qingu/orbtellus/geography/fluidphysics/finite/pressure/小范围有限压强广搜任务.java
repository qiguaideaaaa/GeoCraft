...
import moe.qingu.orbtellus.geography.fluidphysics.pressure.task.FluidPressureSearchTaskSmallRangeRelativeResult;
import moe.qingu.orbtellus.geography.fluidphysics.pressure.task.FluidPressureSmallBFSBaseTask;
...
import static moe.qingu.orbtellus.geography.fluidphysics.ThreadLocalHelper.MUTABLE_POS_S_FOR_REALITY_BFS_RES;

/**
 * @author QiguaiAAAA
 */
public abstract class 小范围有限压强广搜任务 extends FluidPressureSmallBFSBaseTask implements IFinitePressureBFSTask {
    ...
    public 小范围有限压强广搜任务(@Nonnull Fluid fluid, @Nonnull IBlockState beginState, @Nonnull BlockPos beginPos, int searchRange) {
