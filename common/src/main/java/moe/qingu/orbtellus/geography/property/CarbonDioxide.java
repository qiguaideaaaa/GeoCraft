...
import moe.qingu.orbtellus.geography.state.CarbonDioxideState;
...
public class CarbonDioxide extends FluidProperty implements IAtmosphereProperty {
    ...
    protected CarbonDioxide(){
        super(OTCFluids.CARBON_DIOXIDE);
        setRegistryName(new ResourceLocation(OrbTellusCraft.MODID,"carbon_dioxide"));
    }
