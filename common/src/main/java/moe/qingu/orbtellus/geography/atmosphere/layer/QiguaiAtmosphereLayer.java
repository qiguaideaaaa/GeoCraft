...
package moe.qingu.orbtellus.geography.atmosphere.layer;
...
public abstract class QiguaiAtmosphereLayer extends BaseAtmosphereLayer{
    ...
    protected final FluidState water = OTCProperties.WATER.getStateInstance();
    protected final FluidState steam = OTCProperties.STEAM.getStateInstance();
    ...
    public QiguaiAtmosphereLayer(QiguaiAtmosphere atmosphere) {
        ...
        states.put(OTCProperties.WATER,water);
        states.put(OTCProperties.STEAM,steam);
    }
