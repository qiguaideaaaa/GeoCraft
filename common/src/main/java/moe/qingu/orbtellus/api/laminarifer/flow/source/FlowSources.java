...
public final class FlowSources {
    ...
    public static final @Beta IFlowSource<?> RUNOFF = new FlowSource();

    private FlowSources(){}

    public static boolean isAtmosphere(final @Nullable IFlowSource<?> source){
        return source == AtmosphereFlowSource.SOURCE;
    }
    ...
    private static final class FlowSource implements IFlowSource<FlowSource>{}
}
