 ...
 * @author QGMoe
 */
public interface IOperateLayerLaminarifer extends ILaminarifer{

    long operateLayer(@Nonnull final World world,
    ...
    default long addLayer(@Nonnull final World world,
                          ...
                          final long blockFlagsModifier) {
        if(layer <= 0L) return 0L;
        return operateLayer(world, pos, state, fluid, nbt, layer, doOperate, pulse, blockFlagsModifier);
    }
