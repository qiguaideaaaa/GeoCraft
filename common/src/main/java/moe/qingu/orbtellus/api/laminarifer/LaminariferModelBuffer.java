 ...
 * @author QGMoe
 */
public class LaminariferModelBuffer {
    public long maxLayers;
    public long currentLayers;

    public long heightPerLayer;
    public long emptyHeight;
    ...
    public final long getHeight() {
        return emptyHeight + currentLayers * heightPerLayer;
    }

    public final long getMaxAmountInQB() {
        return maxLayers * amountInQBPerLayer;
    }
