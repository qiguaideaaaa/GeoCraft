...
import moe.qingu.orbtellus.api.atmosphere.config.AtmosphereSystemType;
import moe.qingu.orbtellus.api.atmosphere.gen.DefaultAtmosphereDataProvider;
import moe.qingu.orbtellus.api.atmosphere.gen.IAtmosphereDataProvider;
import moe.qingu.orbtellus.api.atmosphere.storage.StorageAtmosphereDataLoader;
import moe.qingu.orbtellus.api.atmosphere.system.IAtmosphereSystem;
import moe.qingu.orbtellus.api.event.atmosphere.AtmosphereSystemEvent;
import moe.qingu.orbtellus.configs.ConfigurationLoader;
import moe.qingu.orbtellus.geography.atmosphere.info.CloseAtmosphereSystemInfo;
...
import moe.qingu.orbtellus.geography.atmosphere.system.CloseAtmosphereSystem;
import moe.qingu.orbtellus.geography.atmosphere.system.SurfaceAtmosphereSystem;
import moe.qingu.orbtellus.geography.atmosphere.system.VanillaAtmosphereSystem;
...
public final class AtmosphereEventHandler {
    ...
    public static void createAtmosphereSystem(AtmosphereSystemEvent.Create event){
        ...
        OrbTellusCraft.getLogger().info("Dimension DIM{} is using atmosphere system type {}",dimension,type);
