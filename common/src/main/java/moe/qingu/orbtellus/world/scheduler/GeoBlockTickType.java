...
import moe.qingu.orbtellus.world.scheduler.boxed.PartialOrderBoxedBlockTickScheduler;
import moe.qingu.orbtellus.world.scheduler.boxed.TotalOrderBoxedBlockTickScheduler;
import moe.qingu.orbtellus.world.scheduler.packed.PartialOrderPackedBlockTickScheduler;
import moe.qingu.orbtellus.world.scheduler.packed.TotalOrderPackedBlockTickScheduler;
...
public enum GeoBlockTickType {
    BOXED(){
        ...
        public Supplier<BlockTickScheduler> supplier(@Nonnull final World world) {
            return () -> PartialOrderBoxedBlockTickScheduler.create(world);
        }
    },
    BOXED_TOTAL_ORDER{
        @Nonnull
